"""Molyar massa — istalgan formulaning element bo'yicha taqsimoti."""
...
page_header(
    "Molyar massa",
    "Bitta formula kiriting — to'liq hisob chiqadi: har bir element qancha ulush "
    "qo'shadi va massaning necha foizini tashkil qiladi.",
    eyebrow="g/mol",
)
...
stats(
    [
        ...
        ("Turli elementlar", str(len(formula.composition))),
    ...
    [
        {
            ...
            "Ulushi (g/mol)": round(subtotal, 4),
            "Massa ulushi": f"{percent:.2f}%",
        }
